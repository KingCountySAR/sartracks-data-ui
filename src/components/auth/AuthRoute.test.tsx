...
it('loading groups', () => {
  const div = document.createElement('div');
  const oidc = { isLoadingUser: false, loadingGroups: true, user: { profile: { } } } as OidcState;
...
it('shows content', () => {
  const div = document.createElement('div');
  const oidc = { isLoadingUser: false, loadingGroups: false, user: { profile: { } } } as OidcState;
...
it('roles-string', () => {
  const div = document.createElement('div');
  const oidc = { isLoadingUser: false, loadingGroups: false, groups: ['users','testers'], user: { profile: { } } } as OidcState;
...
it('self-okay', () => {
  const div = document.createElement('div');
  const oidc = { isLoadingUser: false, loadingGroups: false, groups: ['users','testers'], user: { profile: { memberId: 'my-id' } } } as OidcState;
